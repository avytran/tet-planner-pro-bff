import { TetTimeline } from "../types/tetTimeline.js";

const PI = Math.PI;

export type LunarDate = [number, number, number, number];
...
export function getTetTimelineAuto(dueTime: string | Date): TetTimeline {
